...
generate:
	...
	@# Passes the env var to tell Rust to skip assertions on existing files
	cd $(MANGATAN_DIR) && ONLY_GENERATE_MISSING=1 cargo test --package mangatan-ocr-server --test merge_regression -- --nocapture
